        ...
        <div className="px-4 py-6">
          ...
          <nav aria-label="Main Nav" className="mt-6 flex flex-col space-y-1">
            ...
            <details className="group [&_summary::-webkit-details-marker]:hidden">
              ...
              >
                ...
                >
                  ...
                  <span className="text-sm font-medium"> Using Tour ID </span>
                </Link>

                <Link
                  to="/admindeletetourmanual"
                  className="flex items-center gap-2 rounded-lg px-4 py-2 text-black hover:bg-purple-600 hover:text-white"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            >
              ...
              <span className="text-sm font-medium"> View Booking Info</span>
            </Link>
